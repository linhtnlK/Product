...
public class UserDetailsAdd extends Dialog {
    ...
    public UserDetailsAdd(Shell shell, List<User> list) {
        super(shell);
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        Button addBtn = new Button(bottom, SWT.PUSH);
        addBtn.setText("Add");
        addBtn.setLayoutData(new GridData(SWT.RIGHT, SWT.CENTER, true, true, 1, 1));
        ...
        cancelbtn.setLayoutData(new GridData(SWT.RIGHT, SWT.CENTER, true, true, 1, 1));
